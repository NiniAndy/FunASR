from funasr.tokenizer.g2p_tokenizer_utils import cleaners
from funasr.tokenizer.g2p_tokenizer_utils.text_tokenizers import TextTokenizer
import json
...
class PhonemeBpeTokenizer:
  ...
  def __init__(self, vacab_path="./g2p_tokenizer_utils/vocab.json"):
    self.lang2backend = {
        'zh': "cmn",
        'ja': "ja",
        "en": "en-us",
