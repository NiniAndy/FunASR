...
@tables.register("model_classes", "TextBert")
class TextBert(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        input_vocal_size = kwargs['pny_tokenizer_conf']['vocab_size']
        encoder_class = tables.encoder_classes.get(encoder)
        encoder = encoder_class(input_vocal_size=input_vocal_size, **encoder_conf)
        ...
        self.pny_tokenizer = kwargs.get("pny_tokenizer", None)
    ...
    def encode(
        ...
        **kwargs,
        ...
        Args:
                ...
                ind: int
        """
        encoder_out, encoder_out_lens, _ = self.encoder(pny, pny_lengths)
    ...
    def _calc_att_loss(
        ...
        # 1. Forward decoder
        decoder_out, _,  decoder_out_list= self.decoder.forward_by_layer(encoder_out, encoder_out_lens, ys_in_pad, ys_in_lens)
