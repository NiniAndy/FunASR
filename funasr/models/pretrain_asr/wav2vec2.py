...
@tables.register("pretrain_cfg_classes", "Wav2Vec2")
@dataclass
...
@tables.register("pretrain_classes", "Wav2Vec2")
class Wav2Vec2Model(BaseFairseqModel):

    def __init__(self, cfg: Wav2Vec2Config, spec_augment_config: Dict = None, **kwargs):
        """
...
class ConvFeatureExtractionModel(nn.Module):
    ...
    def get_feat_extract_output_lengths(
        ...
        for kernel_size, stride in zip(
            self.conv_kernel, self.conv_stride
        ):
