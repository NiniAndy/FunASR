...
from funasr.models.transformer.attention import MultiChannelAttention
...
class TransformerMultiDecoder(nn.Module, BatchScorerInterface):
    ...
    def score(self, ys, state, x, **kwargs):
        ...
        logp, state = self.forward_one_step(ys.unsqueeze(0), ys_mask, x.unsqueeze(0), cache=state, language=language)
