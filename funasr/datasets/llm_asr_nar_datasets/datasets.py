...
class LLMASRNARDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # formatting_target = self.answer_template.format(target.lower())  # CN
        formatting_target = self.answer_template.format(target)  # EN

        # input
        input = formatting_target
