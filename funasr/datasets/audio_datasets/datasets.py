...
@tables.register("dataset_classes", "AudioWithDialectDataset")
class AudioWithDialectDataset(torch.utils.data.Dataset):
    """
...
@tables.register("dataset_classes", "AudioWithPNYDataset")
class AudioWithPNYDataset(torch.utils.data.Dataset):
    """
    AudioDataset
    """
    ...
    def __getitem__(self, index):
        ...
        speech, speech_lengths=extract_fbank(data_src, data_type=self.data_type, frontend=self.frontend, is_final=True)
        # speech: [b, T, d]
