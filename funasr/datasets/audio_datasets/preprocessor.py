...
@tables.register("preprocessor_classes", "TextPreprocessRandomError")
class TextPreprocessRandomError(nn.Module):
    def __init__(
        self,
        pinyin_set_path = None,
        initials_distence_path = None,
        vowel_distence_path = None,
        max_mask_prob=0.3,
        mask_lv1_prob=0.1,
        mask_lv2_prob=0.1,
        mask_lv3_prob=0.2,
        ...
        **kwargs
        ...
        self.mask_lv1_prob = mask_lv1_prob
        self.mask_lv2_prob = mask_lv2_prob
        self.mask_lv3_prob = mask_lv3_prob
        self.mask_lv4_prob = mask_lv4_prob
        self.mask_lv5_prob = mask_lv5_prob
        self.pinyin_set_path = pinyin_set_path
        self.initials_distence_path = initials_distence_path
        self.vowel_distence_path = vowel_distence_path
