...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
  ...
  ++ctc_weight=0.3 \
  ++init_param="/ssd/zhuang/code/FunASR/examples/aishell/text_conformer/data/pretrain_text_module/pretrain_text_module_2.pt" \
  ++freeze_param=[text_encoder,text_decoder,text_ctc] \
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  ...
  for dset in ${test_sets}; do
    ...
    inference_dir="${exp_dir}/exp/${model_dir}/inference-${inference_checkpoint}/${dset}_aishell2_decoder"
    ...
    for JOB in $(seq ${nj}); do
        {
          ...
          ++tokenizer_conf.token_list="/ssd/zhuang/code/FunASR/examples/aishell/DATA/data/zh_token_list/char/tokens.txt" \
          ++frontend_conf.cmvn_file="/ssd/zhuang/code/FunASR/examples/aishell/DATA/data/train/am.mvn" \
